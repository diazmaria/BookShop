...
#define AZUL  "\033[0m\033[01;33m"
#define CIAN  "\033[0m\033[01;36m"
#define ROSA  "\033[0m\033[01;31m"
...
int main()
{
  cout.imbue(std::locale(""));
    ...
    cout << AZUL "------------------VENTAS DE ARTÍCULOS--------------\n"
	NORMAL "\n";
    pedido_art.mostrarVentasArticulos(cout);
    
    cout << AZUL "-----------------PRUEBAS DE EXCEPCIONES------------\n"
	NORMAL "\n";
    try {
