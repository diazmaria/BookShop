...
int main()
{
  ...
  Tarjeta 
    visa1(Numero("4539 4512 0398 7356"), lucas, "31/12/2017"),
    american_express(Numero("378282246310005"), hanna, "30/11/2016"),
    dinners_club(Numero("30569309025904"), rosa, "13/7/2018"),
